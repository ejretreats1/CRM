  ...
  return (
    <Layout currentView={view} onNavigate={navigate} isAdmin={isAdmin} mode={mode!} onSelectMode={selectMode} onGoHome={() => setMode(null)}>
      ...
      {(view === 'cleaning-dashboard' || view === 'cleaning-schedule' || view === 'cleaning-jobs' ||
        view === 'cleaning-properties' || view === 'cleaning-cleaners' || view === 'cleaning-payments' || view === 'cleaning-leads' || view === 'cleaning-sops' || view === 'cleaning-email' || view === 'cleaning-scraper') && (
        <CleaningBusiness
          currentView={view}
          onNavigate={navigate}
          reservations={allReservations}
