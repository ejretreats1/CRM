...
export type View = 'dashboard' | 'pipeline' | 'owners' | 'owner-detail' | 'outreach' | 'settings' | 'va-hub' | 'drive' | 'revenue-reports' | 'listing-optimizer' | 'newsletter' | 'guest-marketing' | 'quarterly-reports' | 'properties' | 'property-portal' | 'calendar-intel' | 'email-tracking' | 'deal-scanner' | 'campaigns' | 'sms-outreach' | 'esign' | 'content-studio' | 'cleaning-dashboard' | 'cleaning-schedule' | 'cleaning-jobs' | 'cleaning-properties' | 'cleaning-cleaners' | 'cleaning-payments' | 'cleaning-leads' | 'cleaning-sops' | 'cleaning-email' | 'cleaning-scraper' | 'cleaning-marketing';
