              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-xs font-medium text-slate-600">Personal Note <span className="text-slate-400 font-normal">(appears at top)</span></label>
                    <div className="flex gap-0.5 p-0.5 bg-slate-100 rounded-lg">
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all ${noteTemplate === 'standard' ? 'bg-white text-slate-700 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                        Standard
                      </button>
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all ${noteTemplate === 'sales' ? 'bg-white text-teal-700 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                      >
                        🔥 Get on a Call
                      </button>
                    </div>
      ...
      <div className="bg-white mx-6 mb-6 rounded-2xl border border-slate-200 overflow-hidden print:overflow-visible print:border-none print:rounded-none print:mx-0 print:mb-0">
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="print-section bg-slate-100 rounded-xl p-5 space-y-3">
              ...
              <div className="flex items-center gap-6 flex-wrap">
                <div>
                  ...
                  <div className="text-2xl font-black text-slate-900">{fmt(ownerActualRevenue)}</div>
          ...
          <div className="print-section grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-2 bg-slate-100 rounded-xl p-5">
              <h3 className="text-sm font-bold text-slate-900 mb-2">Executive Summary</h3>
          ...
          {data.keyFindings.length > 0 && (
            <div className="print-section">
              <h3 className="text-sm font-bold text-slate-900 mb-3">Key Findings</h3>
              <ul className="space-y-2">
                {data.keyFindings.map((f, i) => (
          ...
          {data.marketOpportunity && (
            <div>
              <h3 className="text-sm font-bold text-slate-900 mb-2">Market Opportunity</h3>
          ...
          {data.performanceGap && (
            <div>
              <h3 className="text-sm font-bold text-slate-900 mb-2">Performance Gap Analysis</h3>
