  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      ...
      >
        ...
        <span className="flex-1 font-medium text-slate-900 text-sm">{cat.name}</span>
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="font-semibold text-slate-900 mb-3">🎯 Top Priority Fixes</h2>
          <div className="space-y-3">
            {analysis.priorityFixes.map((fix, i) => (
              <div key={i} className="flex gap-3 p-3 bg-slate-100 rounded-lg">
        ...
        {/* Category Cards */}
        <div>
          <h2 className="font-semibold text-slate-900 mb-3">Category Breakdown</h2>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-5">
          <h2 className="font-semibold text-slate-900">✏️ AI Rewrites</h2>

          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Original Title</p>
            <p className="text-sm text-slate-500 bg-slate-100 px-3 py-2 rounded-lg border border-slate-200">{form.title}</p>
            <p className="text-xs font-semibold text-teal-600 uppercase tracking-wider mt-3 mb-2">Suggested Title</p>
            <p className="text-sm text-slate-900 font-medium bg-teal-50 px-3 py-2 rounded-lg border border-teal-100">{analysis.rewrittenTitle}</p>
          </div>

          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Rewritten Opening</p>
            <p className="text-sm text-slate-900 bg-teal-50 px-3 py-2.5 rounded-lg border border-teal-100 leading-relaxed whitespace-pre-wrap">{analysis.rewrittenDescriptionOpening}</p>
          </div>
        </div>

        {/* Keywords */}
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h2 className="font-semibold text-slate-900 mb-3">🔍 SEO Keywords to Include</h2>
